...
var cookie = __webpack_require__(868);
...
const resolveFetch = (customFetch)=>{
    ...
    if (customFetch) {
        ...
        _fetch = (...args)=>Promise.resolve(/* import() */).then(__webpack_require__.bind(__webpack_require__, 981)).then(({ default: fetch1 })=>fetch1(...args));
    } else {
        _fetch = fetch;
    }
...
var cjs = __webpack_require__(485);
...
class RealtimeClient {
     ...
     */ connect() {
        ...
        Promise.resolve(/* import() */).then(__webpack_require__.t.bind(__webpack_require__, 576, 23)).then(({ default: WS })=>{
...
const resolveResponse = ()=>helpers_awaiter(void 0, void 0, void 0, function*() {
        if (typeof Response === "undefined") {
            // @ts-ignore
            return (yield Promise.resolve(/* import() */).then(__webpack_require__.bind(__webpack_require__, 981))).Response;
        }
        return Response;
    });
...
const lib_version_version = "2.49.1"; //# sourceMappingURL=version.js.map
...
var browser = __webpack_require__(981);
...
const module_lib_version_version = "2.68.0"; //# sourceMappingURL=version.js.map
 ...
 */ const module_createClient = (supabaseUrl, supabaseKey, options)=>{
...
;// CONCATENATED MODULE: ./node_modules/@supabase/ssr/dist/index.mjs
...
https://supabase.com/dashboard/project/_/settings/api`);
    ...
    const cookieClientOptions = {
        ...
        auth: {
            flowType: "pkce",
            autoRefreshToken: dist_isBrowser(),
            detectSessionInUrl: dist_isBrowser(),
            persistSession: true,
            storage: {
    ...
    const clientOptions = mergeDeepRight(cookieClientOptions, userDefinedClientOptions);
    if (isSingleton) {
...
https://supabase.com/dashboard/project/_/settings/api`);
    ...
    const clientOptions = es_mergeDeepRight(cookieClientOptions, userDefinedClientOptions);
    return module_createClient(supabaseUrl, supabaseKey, clientOptions);
}
...
async function middleware(request) {
    ...
    const supabase = createServerClient("https://mxuczdeyrczekcyvcshp.supabase.co", "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Im14dWN6ZGV5cmN6ZWtjeXZjc2hwIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NDI4MDUxMTEsImV4cCI6MjA1ODM4MTExMX0.h6wT_HPziCAwPhpOa2hs0MQF9ND76wpCleU-yjLyxSA", {
        cookies: {
            get (name) {
...
// @ts-ignore
const node_fetch_1 = __importDefault(__webpack_require__(981));
const PostgrestError_1 = __importDefault(__webpack_require__(238));
...
const PostgrestQueryBuilder_1 = __importDefault(__webpack_require__(15));
const PostgrestFilterBuilder_1 = __importDefault(__webpack_require__(891));
...
const PostgrestTransformBuilder_1 = __importDefault(__webpack_require__(273));
...
const PostgrestBuilder_1 = __importDefault(__webpack_require__(218));
...
const version_1 = __webpack_require__(307);
...
const PostgrestClient_1 = __importDefault(__webpack_require__(768));
