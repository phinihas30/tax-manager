...
interface EditTaxRecordFormValues {
...
interface EditTaxRecordModalProps {
  record: TaxRecord;
  onClose: () => void;
}

const EditTaxRecordModal: React.FC<EditTaxRecordModalProps> = ({ record, onClose }) => {
  ...
  const { register, handleSubmit, formState: { errors } } = useForm<EditTaxRecordFormValues>({
    defaultValues: {
  ...
  const onSubmit = async (data: EditTaxRecordFormValues) => {
    ...
    <Modal onClose={onClose}>
      <div className="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
        <div className="flex justify-between items-center mb-4">
          <h3 className="text-lg font-medium text-gray-900">Edit Tax Record</h3>
          <button
            onClick={onClose}
...
export default EditTaxRecordModal; 